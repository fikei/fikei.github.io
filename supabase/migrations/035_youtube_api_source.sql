-- ============================================================
-- 035_youtube_api_source.sql
-- Adds 'youtube_api' as a source type for secondary_signals
-- YouTube playlists & liked videos are higher-intent than watch
-- history (Takeout) but lower than user-saved pins.
-- Weight hierarchy: pin=1.0 > youtube_api=0.6 > youtube_takeout=0.35 > spotify=0.3
-- ============================================================
...
ALTER TABLE secondary_signals ADD CONSTRAINT secondary_signals_source_check
  CHECK (source IN ('spotify', 'youtube_takeout', 'youtube_api'));

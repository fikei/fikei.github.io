// job-chat — global chat surface. FAB at bottom-right of every /ladder page;
          ...
          <div class="chat-drawer__thread">
            ${this.messages.length === 0 ? html`
              <div class="chat-empty">
                <p>I'm the /ladder agent. Ask me about your pipeline, paste a role to save, change a stage, or steer your preferences.</p>
              </div>
...
customElements.define('ladder-chat', JobChat);

...
// /ladder/chat/. Two-pane layout: thread list on the left, messages on
...
// (<ladder-chat>). This page exists so the history is a real, browsable
...
customElements.define('ladder-chat-page', JobChatPage);

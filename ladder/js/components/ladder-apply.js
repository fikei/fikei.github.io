  ...
  _renderBar() {
    ...
    return html`
      <header class="apply-bar">
        <div class="apply-bar__brand">/ladder ✨ <span style="color:var(--apply-ink-muted);font-weight:500;">Apply</span></div>
      ...
      <section class="apply-step">
        <div class="apply-step__head">
          ...
          <p class="apply-step__sub">
            ${extracted
              ? html`We mapped the application's standard fields to your /ladder profile — skim, edit anything that's off, and continue.`
...
customElements.define('ladder-apply', JobApply);

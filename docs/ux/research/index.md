...
|-------|------|--------|---------|
| [Widget Template Patterns](./widget-template-patterns.md) | 2026-02-06 | Complete | 30 templates (19 consumption, 1 hybrid, 10 action) across 12 categories, 48 widget concepts. 7 built: grid-split, hero-card, list, text-block, spectrum, stat-row, quick-add |
